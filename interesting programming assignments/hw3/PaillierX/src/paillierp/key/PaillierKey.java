...
public class PaillierKey implements Serializable {
	...
	protected static final int MAX_KEY_SIZE = 2048;//guihongwan: change to 2048 from 512
	...
	public PaillierKey(BigInteger n, Random rnd) {
		//guihongwan
		//System.out.println("The length of n: "+n.bitLength());
	...
	public byte[] toByteArray() {
		...
		//System.arraycopy(n.toByteArray(), 0, r, 0, size);
		System.arraycopy(n.toByteArray(), 0, r, 4, size);//by guihongwan
		return r;
	}
}
